...
```{r head_data, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
head(dataset)  %>% knitr::kable()
```
First Row:
```{r first_row_data, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r show_cm, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
rm(dataset)
```
```{r number_rows_columns, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
nrow(dataset_c)
ncol(dataset_c)
```
...
```{r skim, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
skim(dataset_c)
```
...
```{r count_frauds, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r type_ana, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r data_prep, echo= TRUE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r result_glm, echo= FALSE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r values_rpart, echo= FALSE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
plot(train_rpart)
```
...
```{r tree_rpart, echo= FALSE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r result_rpart, echo= FALSE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r model_ranger, echo= FALSE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
...
```{r result_ranger, echo= FALSE, eval=TRUE, results='hide', warning=FALSE, error=FALSE, message=FALSE}
